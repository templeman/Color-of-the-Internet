...
define("MYSQL_USERNAME", "samue1_color");         // Define your MySQL user name
define("MYSQL_PASSWORD", "rogercorman818");         // Define your MySQL password
define("DATABASE", "samue1_color");               // Define your default database
